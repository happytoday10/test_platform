...
from project_app.p_models import Project
...
class ProjectTest(TestCase):
    ...
    def setUp(self):
        ...
        Project.objects.create(name="test平台",describe="7877")
        self.client = Client()
    ...
    def test_project_cedit(self):
        project  = Project.objects.get(name="test平台")
        # print(222)
        # print(project)
        # print(type(project))
        # print(project.name)
    ...
    def test_project_delete(self):
        ...
        print(8888)
        Project.objects.get(name="test platform9").delete()
        # Project.objects.get(name="测试平台")
        print(77)
        # print(project.name)
        # project.delete()
        response = self.client.post('/manage/project_manage/')
